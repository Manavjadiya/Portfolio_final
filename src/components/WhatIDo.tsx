        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>VIDEO EDITING</h3>
              <h4>High-Retention Content</h4>
              <p>
                Specializing in cashcow videos, faceless content, YouTube long-form, and short-form content like reels and shorts. Clean, fast-paced, and highly engaging.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Hook Structure</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Creating dynamic transitions, pattern interrupts, and visual enhancements tailored for today’s attention economy to elevate the narrative structure.
              </p>
              <h5>Skillset & Focus</h5>
              <div className="what-content-flex">
